    ...
    <div class="card card-body bg-dark mb-3">
        <form method="POST" action="?edit">
            ...
            <div class="row form-group">
                ...
                <div class="col-sm-10">
                    <input type="number" name="availableShares" class="form-control" <% out.print(request.getParameter("availableShares") != null ? "value='" + request.getParameter("availableShares") + "'" : "placeholder='100'"); %> step="any" min="0" />
                </div>
            </div>
            <div class="row">
